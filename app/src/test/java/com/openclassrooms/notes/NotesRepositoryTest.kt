...
class NotesRepositoryTest {
    ...
    @Test
    fun `when getAllNotes is called, it should emit the same list`() = runBlocking {
        // Given
        ...
        every { notesApiService.getAllNotes() } returns expectedNotes

        // When
        val actualNotes = notesRepository.notes.toList().first()
